...
char *ssid = "Anatomka";    //  your network SSID (name) 
...
////////////////////////// end BME280 ///////////////
    ...
    ThingSpeak.setField(4,temperatureFString);
    ThingSpeak.setField(5,humidityString);
    ThingSpeak.setField(6,pressureString);
